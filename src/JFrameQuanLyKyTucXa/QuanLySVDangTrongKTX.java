        ...
        ViewSVLayout.setVerticalGroup(
            ...
            .addGroup(ViewSVLayout.createSequentialGroup()
                ...
                .addGroup(ViewSVLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(ViewSVLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
//        }
    ...
    private void btnAddSVMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddSVMouseClicked
        ...
        //AddSVVaoKTX.setVisible(false);
        //new QuanLySinhVienDAO().updateDKthanhcong((String) cbbMaSV.getSelectedItem());
...
//    private void updatePhongComboBox(String gioiTinh) {
//        try {
//            String query = "SELECT maPhong FROM Phong WHERE gioiTinh = ?";
//            PreparedStatement preparedStatement = ketNoiSQL.getConnection().prepareStatement(query);
//            preparedStatement.setString(1, gioiTinh);
//            ResultSet resultSet = preparedStatement.executeQuery();
//
//            // Xóa tất cả các option hiện có trong JComboBox
//            ComboBoxMaPhong.removeAllItems();
//            while (resultSet.next()) {
//                String maPhong = resultSet.getString("maPhong");
//                ComboBoxMaPhong.addItem(maPhong);
//            }
//
//            resultSet.close();
//            preparedStatement.close();
...
//            if (rs.next()) { 
//                txtViewMaSoSV.setText(rs.getString("maSV"));
//                txtViewMaPhongSV.setText(rs.getString("maPhong"));
//            } else {
//            }
//        } catch (SQLException ex) {
//            Logger.getLogger(DangKiPhong.class.getName()).log(Level.SEVERE, null, ex);
